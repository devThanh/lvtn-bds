...
realEasteRouter.post('/create-info', upload.array('images',10), authMiddleware.authorize, realEasteNewsMiddleware.validateCreate_EditInfo, realEasteNewsController.infoRealEaste)
realEasteRouter.put('/edit-info/:real_easte_id', authMiddleware.authorize, realEasteNewsMiddleware.validateCreate_EditInfo, realEasteNewsController.editInfoRealEaste)
